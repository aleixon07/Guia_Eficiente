...
if (!isset($_GET['id']) && empty($_GET['id'])) {
    ...
    $id_busc_existe_componente = $_GET['id'];

    $sql_busc_existe_componente = "SELECT * FROM componente WHERE IdComponente = '$id_busc_existe_componente' LIMIT 1";
    $result_busc_existe_componente = mysqli_query($conn, $sql_busc_existe_componente);

    if (mysqli_num_rows($result_busc_existe_componente) == 0) {
        header("location: ./");
        exit();
    }

    $row = mysqli_fetch_assoc($result_busc_existe_componente);
}
...
<head>
    ...
    <title>Editando Componente | Guia Eficiente</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h4 class="mb-5">Editando Componente</h4>

                    <form action="../scripts/edit_componente.php" method="POST" enctype='multipart/form-data'>
                        <input type="hidden" name="edit" value="<?php echo $row['IdComponente']; ?>">
                        ...
                        <input type="color" name="cor" class="form-control w-25 mt-4" id="cores" value="<?php echo $row['Cor']; ?>" />
                        <p><em>*Caso não selecione a cor, por padrão ela irá como branco.</em></p>

                        <select name="opcao" class="form-select form-control mt-3" aria-label="Default select">
                            <?php $opcao = $row['Opcao']; ?>
                            <option <?php if ($opcao == 1) echo "selected"; ?> value="1">1 (Imagem a esquerda com texto e título a direita)</option>
                            <option <?php if ($opcao == 2) echo "selected"; ?> value="2">2 (Texto e título a direita e imagem a esquerda)</option>
                            <option <?php if ($opcao == 3) echo "selected"; ?> value="3">3 (Texto e título sem imagem)</option>
                        </select>
                        ...
                        <div>
                            <img class="rounded mb-3" <?php
                                                        ...
                                                        ?> style="width: 40%; height: auto;" id="preview">
                        </div>
