...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['nome']) && isset($_POST['email']) && isset($_POST['senha'])) {
        ...
        if ($error) {
            ...
            $error2 = md5($error);
            header("Location: ../cadastra.php?e=$error2");
            exit();
            ...
            if (mysqli_num_rows($result_email) > 0) {
                ...
                header("Location: ../cadastra.php?e=1679091c5a880faf6fb5e6087eb1b2dc");
                exit();
            }
            
            $senha2 = password_hash($senha, PASSWORD_DEFAULT);
            $sql = "INSERT INTO usuario (Nome, Senha, Email, Nivel) VALUES ('$nome', '$senha2' , '$email', '$nivel')";
