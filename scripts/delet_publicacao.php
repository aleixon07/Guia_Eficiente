    ...
    if (mysqli_num_rows($result_usuario) == 0) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "GET") {
            ...
            if (isset($_GET['id']) && !empty($_GET['id'])) {
                ...
                $sql_usuario_excluido = "SELECT * FROM publicacao WHERE IdPublicacao = '$id_excluir' LIMIT 1";
                ...
                $foto = $row_usuario_excluido["Foto_Principal"];

                $DiretorioFotos = " ../fotos";

                $caminho_foto = $DiretorioFotos . '/' . $foto;
                ...
                $sql_delet = "DELETE FROM publicacao WHERE IdPublicacao = '$id_excluir'";
